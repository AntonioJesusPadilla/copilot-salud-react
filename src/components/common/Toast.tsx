...
function Toast({ toast, onClose }: ToastProps) {
  ...
  return (
    <div
      className={`flex items-center gap-3 w-full max-w-sm p-4 rounded-lg shadow-lg border-l-4 ${config.bgColor} ${config.borderColor} transition-all duration-300 transform ${animationClasses}`}
      role="alert"
    >
      {/* Icono */}
      ...
      {/* Mensaje */}
      <div className={`flex-1 text-sm font-medium ${config.textColor}`}>{toast.message}</div>
